...
class DoctorEducationPage extends StatefulWidget {
  const DoctorEducationPage({super.key});

  @override
  State<DoctorEducationPage> createState() => _DoctorEducationPageState();
}

class _DoctorEducationPageState extends State<DoctorEducationPage> {
